...
import { CalendarDays, MapPin, Users, Edit, UserPlus, Check } from "lucide-react";
...
export const ProfileHeader = ({ profile, isOwnProfile }: ProfileHeaderProps) => {
  const [isFollowing, setIsFollowing] = useState(false); // TODO: Conectar con backend real (isFollowedByMe)
        ...
        <div className="relative flex flex-col items-start">
          ...
          <div className="-mt-12 mb-3 md:-mt-16">
            <Avatar className="h-24 w-24 border-4 border-background md:h-32 md:w-32">
              <AvatarImage src={profile.avatarUrl || undefined} alt={profile.username} className="object-cover" />
